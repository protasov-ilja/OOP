...
// Зависимости RemoteControl-a вынесены в родительскую структуру,
// чтобы гарантировать их создание до конструирования самого remote-котнтроллера
...
struct RemoteControlFixture : RemoteControlDependencies
{
	...
	// Она принимает ожидаемый номер канала expectetChannel и expectedOutput
